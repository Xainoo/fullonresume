...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    classifier_title: "Image Analyzer",
    classifier_desc: "Browser-based image classifier.",
    ...
    chat_title: "Realtime chat",
    chat_desc: "Uses Pusher channels for WebSocket-style realtime messaging.",
    ...
    nav_home: "Home",
    nav_image_analyzer: "Image Analyzer",
    nav_chat: "Chat",
    nav_weather: "Weather",
    ...
    image_analyzer_title: "Image Analyzer",
    image_analyzer_desc: "Browser-based image classifier using TensorFlow.js.",
    image_analyzer_long:
      "Image Analyzer demo: upload an image or use your camera to run client-side image classification. Ideal for small, client-side ML demos on static hosts.",
    ...
    display: "Display",
    balance: "Balance",
    budget_help: "Set a monthly spending budget (expenses only).",
  ...
  pl: {
    ...
    classifier_title: "Analizator obrazów",
    classifier_desc: "Klasyfikator obrazów.",
    ...
    chat_desc: "Używa kanałów Pusher do komunikacji w czasie rzeczywistym. ",
    ...
    nav_image_analyzer: "Analizator obrazów",
    nav_chat: "Czat",
    nav_weather: "Pogoda",
    nav_portfolio: "Portfolio",
    ...
    image_analyzer_title: "Analizator obrazów",
    image_analyzer_desc:
      "Klasyfikator obrazów działający w przeglądarce z użyciem TensorFlow.js.",
    image_analyzer_long:
      "Demo Analizatora obrazów: prześlij zdjęcie lub użyj aparatu, by uruchomić klasyfikację obrazów po stronie klienta. Świetne dla małych demonstracji ML na statycznym hostingu.",
    ...
    display: "Widok",
    balance: "Saldo",
    budget_help: "Ustaw miesięczny budżet wydatków.",
    no_transactions: "Brak transakcji.",
    currency_PLN: "Polski złoty",
    currency_USD: "Dolar USA",
    currency_EUR: "Euro",
    currency_DKK: "Korona duńska",
